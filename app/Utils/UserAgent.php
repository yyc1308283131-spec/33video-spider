...
/**
 * User-Agent 管理工具
 * 提供桌面端和移动端 User-Agent 随机选择功能
 */
class UserAgent
{
    private static $desktopUserAgents = [
    ...
    {
        return self::$desktopUserAgents[array_rand(self::$desktopUserAgents)];
    }
    ...
    {
        return self::$mobileUserAgents[array_rand(self::$mobileUserAgents)];
    }
}
